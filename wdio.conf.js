var browserSettings = require('./settings/wdio.browsers.setup');
const info = require('./settings/info');
var date = require('date-and-time');
var os =require('os')
const datetime = info.getFormattedDate("_","_");
const reportSufix = process.env.BUILD_NUMBER || datetime;
...
exports.config = {
    ...
    capabilities: [{
        ...
        maxInstances: 3,
        //
        browserName: 'chrome', //chrome //internet explorer //firefox
    ...
    //     maxInstances: 3,
    //     //
    //     browserName: 'firefox', //chrome //internet explorer //firefox
    ...
    baseUrl: 'http://10.183.94.100/app/',
    //
    ...
    reporters: ['dot','spec','multiple-cucumber-html','allure'],
    reporterOptions: {
        allure: {
        ...
        htmlReporter:{
            ...
            ,customData: {
              ...
              data: [
                  ...
                  {label: 'Release', value: '7.4.7814'},
                  {label: 'Cycle', value: 'Release'},
                  {label: 'Execution Start Time', value: info.getNewFormattedDateTime()},
                  {label: 'Execution End Time', value: date.format(new Date(),'DD/MMM/YYYY/ HH:mm:ss [GMT]')}
              ]
             }
    ...
    cucumberOpts: {
        require: require('glob').sync('./tests/steps/**/*'),
